%-----------------------------------------------------------------------
%;  Copyright (C) 1995-1996, 1998, 2000-2018
...
\subsections{Other image combination options}
     ...
     {\tt \tndx{COMB}} may also be used to re-scale images, and to
...
\centerline{\vbox{\halign{\lft{{\us #}}\qquad&\lft{#}\qquad
 ...
 \noalign{\vskip 2pt}
   ...
   \     &\             &\phantom{{\MAP}_1\qquad
                              \mbox{except blanked when}}\mbox{or}\quad
                              a_2 > a_1 > {\MAP}_2\cr
   \     &\             &\phantom{{\MAP}_1\qquad
                              \mbox{except blanked when}}\mbox{or}\quad
                              {\MAP}_2 > a_2 > a_1\cr}}}
...
the task {\tt \Tndx{SPFIX}} may be used to construct a model image
...
\dispt{GO\qs \tndx{TKPL} \CR}{to display the histogram in the
         Tektronix window.}
...
useful advice.  {\tt \tndx{SKYVE}} re-grids images from the Digital Sky
...
image cubes are discussed in \Sec{lineanal}.  Models of galaxy rotation
