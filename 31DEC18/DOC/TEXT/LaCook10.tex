...
%;  Copyright (C) 2010, 2013-2014, 2016, 2018
...
\dispt{DOCRT\qs 1 \CR}{to view the listing, one page at a time, on
          ...
          uses the actual width of the window and so maximizes the
...
\Tndx{BSGEO}} to re-grid the data onto normal celestial coordinates.
...
\dispt{APARM\qs 0 \CR}{to do no shifts or re-scaling.}
