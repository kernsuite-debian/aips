...
\renewcommand{\titlea}{31-DEC-2018 (revised 30-August-2018)}
...
of more than 2 dimensions.  \Rappen{Olderdata} is designed for users of
the historic VLA archive and for older VLBI formats.  Similarly,
\Rchap{vlbi} and \Rappen{VLBAeasy} are aimed primarily at users of VLB
interferometers.  \Rchap{sd} deals with single-dish data reduction
with \AIPS\@.  \Rchap{exit} describes how to help the \AIPS\
