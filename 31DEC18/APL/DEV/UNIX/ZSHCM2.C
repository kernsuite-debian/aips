...
#if __STDC__
   void zshcm2_(int *lcom, char *commnd, int *ltask, char *outdev,
      int *ierr)
#else
   void zshcm2_(lcom, commnd, ltask, outdev, ierr)
   int *lcom, *ltask, *ierr;
   char commnd[], outdev[];
#endif
/*--------------------------------------------------------------------*/
...
/*# Z3 System                                                         */
/*--------------------------------------------------------------------*/
/*;  Copyright (C) 1995-1997, 2004-2005                               */
...
/*     ltask    I       length of outdev  IGNORED                     */
...
/*  UNIX version - OUTDEV argument currently ignored                  */
/*--------------------------------------------------------------------*/
{
   register int i, j;
   char com[MAXCOM];
