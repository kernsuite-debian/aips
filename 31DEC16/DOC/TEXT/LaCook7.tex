%-----------------------------------------------------------------------
%;  Copyright (C) 1995-1996, 1998, 2000-2016
...
pixel.  Task {\tt \tndx{FLATN}} can compute weight and noise images
...
\Subsections{Spectral parameter fitting (\/{\tt TVSPC}, {\tt XGAUS}, {\tt ZEMAN}, {\tt RMFIT}, {\tt FARS})}{fars}
     ...
     In {\tt 31DEC16}, the new task {\tt \Tndx{TVSPC}} has appeared to
...
In ealier releases, use {\tt \tndx{XPLOT}} with {\tt DOTV 1} to
...
Cleaning.  Task {\tt \Tndx{AFARS}} reads these cubes to produce images
of the maximum rotation measure and of the amplitude or phase at the
maximum.  Task {\tt \Tndx{RFARS}} applies the rotation measure image
to the {\tt FARS} input cubes to produce de-rotated cubes of Q and U.
These may be {\tt \tndx{SQASH}}'ed to make an image of the average
un-rotated polarization.  The {\tt RUN} file/procedure {\tt
\Tndx{DOFARS}} assists with the whole process, doing matrix
...
\tndx{UVMOD}}, and {\tt \tndx{SPMOD}} will add (or subtract) up to
