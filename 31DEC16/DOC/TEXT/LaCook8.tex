%-----------------------------------------------------------------------
%;  Copyright (C) 1995, 1998, 2000-2002, 2004-2005, 2007-2011, 2013-2016
...
the sections on editing (\Sec{initedit} and \Sec{caledit}) and on
...
\iodx{undefined pixel}  The new task {\tt \tndx{RMSD}} can be used to
...
\resizebox{!}{3.7in}{\gbb{536,522}{momnt}}
...
might be rather time-consuming.\iodx{fitting}  In {\tt 31DEC13}, {\tt
...
\tndx{OHGEO}} to regrid the image instead.  A single profile can be
