...
#if __STDC__
   void zexpn2_(int *fcb, int *map, int *nrecs, int *ierr)
#else
   void zexpn2_(fcb, map, nrecs, ierr)
...
/*--------------------------------------------------------------------*/
{
   ...
   extern int Z_mfcb;
                                        /* # of bytes per word        */
   extern int Z_nbpwd;
   int fd, recsiz, nby, jerr, n8 = 8;
   off_t size, lastiob;
   register int i;
   char *buff = NULL, msgbuf[80];
