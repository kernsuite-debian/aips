...
/*                      3 => I/O error                                */
/*                      4 => end of file                              */
/*                      5 => beginning of tape (not from this version)*/
/*                      6 => end of tape (not from this version)      */
/*  SGI UNIX version - only synchronous I/O.                          */
/*--------------------------------------------------------------------*/
{
         ...
         if (ioctl(*fcb,MTIOCGET,&stat) != 0) {
            *ierr = 3;
            ...
            printf ("ZTPWA2: stat.mt_type = %d, out ierr = %d\n",
               stat.mt_type,*ierr);
            printf ("ZTPWA2: mt_dposn %x mt_dsreg %x mt_erreg %x\n",
