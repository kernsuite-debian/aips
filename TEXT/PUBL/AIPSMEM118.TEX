...
\begin{abstract}
  ...
  discusses \Me{changes made for the {\tt 31DEC15} release and two new
  tasks to plot spectra with model fits and} a number of tasks which
  make visibility and image model files.  \Hi{The November 2017
...
\begin{figure}
\begin{center}
\resizebox{5.0in}{!}{\putfig{RMFIT.3pa}}
\caption{\Hi{Model field first pixel total polarization and angle
    spectra, fit with three components.}}
\label{fig:RMFIT.3pa}
\end{center}
\end{figure}
...
\begin{tabular}{|l|l|}\hline
   ...
   {\tt BAD}      & {\tt B} \\
   {\tt PIXRANGE} & {\tt P} \\
\Hi{{\tt SHOW Q\&U}} & \Hi{{\tt S}} \\
\Hi{{\tt SHOW P\&A}} & \Hi{{\tt S}} \\
   {\tt 1}        & {\tt 1} \\
   {\tt 2}        & {\tt 2} \\
   {\tt 3}        & {\tt 3} \\
   {\tt QUIT}     & {\tt Q} \\ \hline
