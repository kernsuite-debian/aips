...
%-----------------------------------------------------------------------
\input COOK82G.MAC
%\input uma0:[fred.tex]letams.tex
%\input uma0:[fred.tex]eightpt.tex

% Also for laser printer, need a bit of a vertical offset from the
% origin:
%\voffset=-.3in
...
\def\twocol{T}\hsize 3.1in
\tsect{G. Glossary}
\def\regpt{\eightpoint}
\regpt\parskip 0pt plus 1 pt
...
\def\aa#1{\parsep{\bf{#1}} ---\iodx{#1}\mark{{#1}}}
